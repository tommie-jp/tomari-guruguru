...
EXE のビルド自体は [10-単体EXEにする.md](10-単体EXEにする.md)、通常運用は
[09-Windowsで動かす.md](09-Windowsで動かす.md)、テスト全体の方針は
[14-テスト.md](14-テスト.md) を参照。ここは「公開済みリリースを落として動くか」だけを見る。
...
- **SmartScreen で止まらないように**: ダウンロードした zip と解凍後のツリーから
  ...
  （[10-単体EXEにする.md](10-単体EXEにする.md) の SmartScreen 注意点と同じ理由）。
