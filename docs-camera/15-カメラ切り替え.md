...
関連: [11-WS中継の接続手順.md](11-WS中継の接続手順.md) / [14-Windowsで動かす.md](14-Windowsで動かす.md) / [54-テスト.md](54-テスト.md)
...
カメラ実機が要る経路（`useFacePose` の列挙・リトライ）は方針どおりテスト対象外（[54-テスト.md](54-テスト.md)）。
